...
<head>
    ...
    <!-- Custom CSS para visual tecnológico -->
    <style>
        body {
        ...
        /* Bordas e sombras neon para o formulário */
        form#formulario {
            background: #1a1a1a;
            padding: 20px;
            border-radius: 10px;
        ...
        /* Estilo para os input-group-text e botões */
        .input-group-text {
            background: linear-gradient(45deg, #00ffff, #004f4f);
            color: #fff;
            border: none;
        }
        ...
        .btn-primary:hover {
            background: linear-gradient(45deg, #00e6e6, #003f3f);
        }

        /* Estilo para os cards com um toque high-tech */
        .card {
        ...
        /* Inputs e selects com bordas neon */
        .form-control,
            .form-select {
        ...
        /* Estilo para os elementos que mostram mensagens ou histórico */
        .badge.text-bg-info {
            background: linear-gradient(45deg, #00ffff, #005555);
            box-shadow: 0 0 5px #00ffff;
        }
    </style>
        ...
        <form id="formulario">
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <button class="btn btn-primary" id="inserir" type="button">
                        Inserir
                    </button>
                </div>
            </div>
            ...
            <div class="card mt-4">
                <div class="card-header">Selecione os Atributos</div>
                <div class="card-body">
                    ...
                    <div class="container mt-4">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="radioName" value="fotos"
                                id="checkbox_id" />
                            <label class="form-check-label" for="fotos">Fotos</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="radioName" value="info"
                                id="checkbox_id" />
                            <label class="form-check-label" for="info">Ficha Técnica</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mt-4">
                <div class="card-header">Selecione o tipo de cadastro</div>
                <div class="card-body">
                    ...
                    <div class="container mt-4">
                        ...
                        <input class="form-check-input" type="radio" name="tp_cadastro" value="duplicar"
                            id="duplicar" />
                        <label class="form-check-label" for="duplicar">Duplicar</label>

                        <input class="form-check-input" type="radio" name="tp_cadastro" value="variacao"
                            id="variacao" />
                        <label class="form-check-label" for="variacao">Variação</label>
                    </div>
                </div>
            </div>
            ...
            <div class="row p-4">
                <div class="col-md-6">
                    <div class="col">
                        <div class="mb-6 row">
                            <label class="col-lg-2 col-md-3 col-sm-6 col-form-label">
                                Categorias:
                            </label>
                ...
                <div class="col-md-4 p-4">
                    <div class="col">
                        <div class="mb-3 row">
                            <ol class="list-group list-group-numbered content_categorias"></ol>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="btn-group mt-4" role="group" aria-label="Botões">
                <button type="button" id="trocar" class="btn btn-secondary x-2">
                    Trocar <i class="bi bi-sunset-fill"></i>
                </button>
