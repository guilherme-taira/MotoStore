    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6">
                ...
                <div class="card bg-success text-white mb-4">
                    ...
                    <a class="small text-white stretched-link btn btn-warning py-2" href="https://auth.mercadolivre.com.br/authorization?response_type=code&client_id=3029233524869952&redirect_uri=https://afilidrop.com.br/thankspage" >Renovar token</a>
                </div>
                @else
                ...
                <div class="card bg-warning text-white mb-4">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="https://auth.mercadolivre.com.br/authorization?response_type=code&client_id=3029233524869952&redirect_uri=https://afilidrop.com.br/thankspage" >Integrar</a>
                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                    </div>
                </div>
                @endif
