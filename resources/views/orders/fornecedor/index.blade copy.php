                                            ...
                                            <div class="card-body">
                                                ...
                                                <form id="merge-labels-form" class="mb-5">
                                                    @foreach ($viewData['orders'] as $order)
                                                        <div class="card mt-4 shadow-lg border-0">
                                                            <div
                                                                ...
                                                                <div class="card shadow-sm border-0 rounded"
                                                                    ...
                                                                    <input type="hidden" class="shipping-id"
                                                                        value="{{ $order->shipping_id }}">
                                                                    <div class="modal-tracking-details text-muted mt-2"
                                                        ...
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="trackingModal-{{ $order->id }}"
                                                            tabindex="-1"
                                                            aria-labelledby="trackingModalLabel-{{ $order->id }}"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-right">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="trackingModalLabel-{{ $order->id }}">
                                                                    ...
                                                                    <div
                                                                        class="modal-body modal-tracking-details-{{ $order->shipping_id }}">
