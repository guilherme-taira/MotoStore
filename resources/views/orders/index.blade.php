                ...
                <div class="d-flex text-muted pt-3">
                    ...
                    <p class="pb-3 mb-0 small lh-sm d-block">
                        <strong class="d-block text-gray-dark"><a class="text-decoration-none"
                                href={{ route('orders.show', ['id' => $order->id]) }}>{{ $order->name }}</a></strong>
                        {{-- content --}}
                        ID do Pedido: {{ $order->id }}, Total R$: {{ $order->total }}, Data do Pedido:
                        {{ $order->created_at }}, Forma de Pagamento : {{ $order->pagamento }}
                    </p>
                </div>
                <hr>
            @endforeach
