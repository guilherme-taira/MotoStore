    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-lg-8 pb-5">
                ...
                <form class="row" action="{{ route('atualizarEndereco', ['id' => $viewData['user']->id]) }}" method="get">
                    @csrf
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="cep" id="cep" type="number"
                                ...
                                onKeyPress="if(this.value.length==8) return false;" value="{{$viewData['user']->cep}}" required="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="account-email">Logradouro: </label>
                            <input class="form-control" name="logradouro" value="{{$viewData['user']->address}}" type="text" id="logradouro">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="account-email">Bairro: </label>
                            <input class="form-control" name="bairro" value="{{$viewData['user']->bairro}}" type="text" id="bairro">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="account-email">Cidade: </label>
                            <input class="form-control" name="cidade" value="{{$viewData['user']->cidade}}" type="text" id="cidade">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="account-email">Complemento: </label>
                            <input class="form-control"name="complemento" value="{{$viewData['user']->complemento}}" type="text" id="complemento">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="account-email">Número: </label>
                            <input class="form-control" name="numero" value="{{$viewData['user']->numero}}" type="text" id="numero">
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center">
                            <input type="submit" value="Salvar" class="btn btn-style-1 btn-success">
                        </div>
                    </div>
                </form>
            </div>
