    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="row g-3 needs-validation" method="POST" action="{{route('bancario.store')}}" novalidate>
                    @csrf
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="agencia" id="validationCustom02" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="acount" id="validationCustom02" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="cpnj" id="validationCustom02" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                    </div>
