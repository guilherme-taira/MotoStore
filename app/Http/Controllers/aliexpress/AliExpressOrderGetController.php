...
class AliExpressOrderGetController extends Controller
{
    ...
    const URL_BASE_ALIEXPRESS = "https://api-sg.aliexpress.com/sync?method=";
    ...
    public function resource()
    {
        ...
        $this->get("aliexpress.solution.order.get"."&app_key=".$this->getAppKey()."&access_token=".$this->getAccessToken()."&timestamp=".$this->msectime()."&sign_method=sha256&sign=".$this->generateSign($this->getUrl(), $dataForGenerateSign));
    }
